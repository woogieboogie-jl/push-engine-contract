...
/**
 * @title IDataStreamsPostUpdateHook
 * @author Tyler Loewen, TRILEZ SOFTWARE INC. dba. Adrastia
 * @notice An interface for a hook that is called immediately after a Chainlink Data Streams feed report is updated.
 * This interface allows for custom logic to be executed after a report is updated, such as logging, triggering
 * events, or interacting with other contracts.
 */
interface IDataStreamsPostUpdateHook {
    /**
     * @notice Called immediately after a report is updated in the Chainlink Data Streams feed.
     *
